...
<form action="<?=$PHP_SELF?>" method="GET">
    <input type="text" size="30" name="page_title" value="<?php if (isset($page_title)) print $page_title;?>">
    <select name="search_type">
	<option value='exact'<?php if (isset($search_type) && $search_type=='exact') print " selected"; ?>>exact search</option>
	<option value='sub'<?php if (isset($search_type) && $search_type=='sub') print " selected"; ?>>substring search</option>
    </select>
